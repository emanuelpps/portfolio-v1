  ...
  return (
    <div className="relative w-[90vw] lg:w-85 h-full lg:h-[420px] rounded-[40px] border-[1px] border-r-transparent border-t-white/10 border-b-transparent border-l-white/10 bg-gradient-to-b from-white/5 to-transparent backdrop-blur-md shadow-xl hover:bg-[#FF4D7D] transition-colors duration-500 cursor-pointer">
      <Link to={`/project/${project.id}`} state={project}>
        ...
        <motion.div
          className="relative w-full lg:w-85 h-[420px]  rounded-[40px]"
        ...
        >
          ...
          />
          <div className="hidden lg:flex absolute right-[0px] top-[298px] w-[20px] lg:w-[40px] h-[40px] z-30 bg-transparent rounded-br-[40px] shadow-[8px_12px_0px_4px_#0F1724]" />
          <div className="hidden lg:flex absolute left-[165.5px] lg:left-[166px] bottom-[1px] lg:w-[40px] w-[20px] h-[40px] z-30 bg-transparent rounded-br-[40px] shadow-[8px_12px_0px_4px_#0F1724]" />
        </motion.div>
        <div
          id="tab-curve"
      ...
      <div className="absolute overflow-visible bottom-0 right-0 z-[90] flex items-center justify-center after:bg-[#0F1724] rounded-l-[50px] p-[1rem] after:w-[240px] after:h-[127px] after:content-[''] after:absolute after:top-[-5] after:rounded-tl-[40px] after:rounded-r-none"></div>
      <div
        id="curve-one"
