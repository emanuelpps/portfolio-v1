    ...
    <div className="flex flex-col items-center w-full">
      ...
      >
        <div className="text-center flex flex-col md:flex-row md:w-[80%] justify-center md:justify-between items-center h-[100px]">
          <div className="flex items-center justify-center w-full md:justify-start md:text-start">
            {SkillsTitle.render()}
          </div>
          <div className="flex justify-center w-full md:items-end md:justify-end">
