...
export const SkillsContainer = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full">
      <motion.div
        ref={ref}
        className="backdrop-blur-lg shadow-lg max-w-[95vw] md:w-full md:max-w-7xl flex flex-col items-center rounded-2xl px-6 py-3 gap-8 p-8 shadow-gray-900 border border-gray-800 [mask-image:linear-gradient(to_bottom,white_95%,transparent)] bg-gray-900/50 min-h-[500px] md:min-h-[400px]"
